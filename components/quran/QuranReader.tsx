...
Explain the root words, linguistic context, and practical spiritual reflections.`);
  ...
  return (
    <div id="quran-reader-container" className="flex flex-col min-h-screen pb-24">
      ...
      {showSettings && (
        <div className="max-w-3xl mx-auto w-full p-4 mb-6 rounded-2xl bg-card border border-border shadow-md space-y-4 animate-in slide-in-from-top-2">
          <div className="flex items-center justify-between text-xs font-bold text-foreground border-b border-border pb-2">
            ...
            <span className="text-muted-foreground">Customized locally</span>
          </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <label className="flex items-center gap-1.5 cursor-pointer">
                <input
                  ...
                  className="rounded-sm accent-primary"
                />
                <span className="text-foreground">தமிழ் (Tamil)</span>
              </label>
      ...
      {chapter.bismillahPre && (
        <div className="text-center py-6 mb-4">
          <p className="text-3xl font-arabic text-primary-strong">
